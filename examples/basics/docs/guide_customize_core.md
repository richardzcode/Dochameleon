...
Let's say you don't like sidebar at the left side for docs. Just create copy core `components/docs/DocsLayout.js` from core library to `website/components/docs`, then modify render function to switch the order of sidebar can content.
