  ...
  render() {
    ...
    return (
      <head>
        ...
        { site.icon && <meta property="og:image" content={site.urlWithRoot(site.icon)} /> }
        ...
        }
        {
          ...
          config.js.map((source, idx) => {
            ...
            return source.async
              ? <script type="text/javascript" key={'script' + idx} src={src} async />
              : <script type="text/javascript" key={'script' + idx} src={src} />
          })
        }
      </head>
    );
