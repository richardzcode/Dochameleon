function execute() {
  ...
  const DocsLayout = require('../docs/components/DocsLayout.js');
  ...
  const BlogPostLayout = require('../blog/components/BlogPostLayout.js');
  ...
  const BlogPageLayout = require('../blog/components/BlogPageLayout.js');
  const perPage = 10;
